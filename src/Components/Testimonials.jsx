    ...
    <section id="testimonials" className={Classes.testimonials}>
      ...
      <div className={Classes.boxContainer}>
        <div className={Classes.testimonialBox}>
          ...
          <p>
            2wards has such a user-friendly website. Easy to navigate, search
            and fiddle with dates instead of having to call up. Once decided,
            the booking process was swift and easy, thank you.
          </p>
